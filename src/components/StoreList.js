...
export default function StoreList(){
    return(
        <div style={{margin: "auto"}}>
            <h2 style={{ fontSize: "36px", lineHeight: "50px", marginTop: "20px", textAlign: "center", fontWeight: "normal" }}>Browse stores in Norfolk</h2>
            <Container style={{ marginTop: "50px", textAlign: "center" }}>
                <Row style={{ borderBottom: "1px solid ", display: "flex", justifyContent: "space-evenly"}} >
                    <Row>
                        <Col xs=".5" >
